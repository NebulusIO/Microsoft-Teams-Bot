...
3. Give the bot a handle (ex: `atlasBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://reactmsteamstabsapp.azurewebsites.net/api/messages`
