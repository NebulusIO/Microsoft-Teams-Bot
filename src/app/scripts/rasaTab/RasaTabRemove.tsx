...
export interface IRasaTabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface IRasaTabRemoveProps {

}

/**
 * Implementation of Rasa remove page
 */
export class RasaTabRemove  extends TeamsBaseComponent<IRasaTabRemoveProps, IRasaTabRemoveState> {
